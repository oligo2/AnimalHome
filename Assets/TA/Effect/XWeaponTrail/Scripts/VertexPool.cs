...
namespace XftWeapon {
    ...
    public class VertexPool
    {
        ...
        protected Material _heatMaterial;
        ...
        public VertexPool(Material material, Material heatMaterial, XWeaponTrail owner)
        {
        ...
        public void LateUpdate()
        {
            ...
            if(_heatMaterial!=null)
                Graphics.DrawMesh(MyMesh, Matrix4x4.identity, _heatMaterial, _owner.gameObject.layer, null, 0, null, false, false);
        }
    }
}