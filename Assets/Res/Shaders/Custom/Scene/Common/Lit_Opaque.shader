Shader "Oligo/Scene/Common/Lit-Opaque"
{
	Properties
	{
		...
		[Space]
		[Foldout(1,2,1,0,LOD0,LOD1)] _EnableParallax("视差_Foldout", float) = 0
		[Switch(LOD0,LOD1)] _DepthMap("深度图（越黑越深）", 2D) = "white" {}
		[Switch(LOD0,LOD1)] _Depth("深度", Range(0,5)) = 1
		[Foldout_Out(1)] _EnableParallax_e("_Foldout", float) = 1
