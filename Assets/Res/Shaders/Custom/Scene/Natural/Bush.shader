Shader "Baha/Scene/Natural/Bush"
{
// 	Properties
// 	{
...
// 		[Space]
// 		[Foldout(1,2,10,LOD0,LOD1)] _EnableEmission("自发光_Foldout", float) = 0
...
// 	SubShader
// 	{
// 		Tags{"RenderType"="_BaseMap" "Queue" = "Geometry+472"} // RenderType,用作SceneViewDebug的标识，意为albedo的属性    王英杰            
// 		Cull Off
