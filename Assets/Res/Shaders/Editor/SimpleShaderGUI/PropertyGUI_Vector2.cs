...
namespace Scarecrow
{
    public class Vector2Drawer : MaterialPropertyDrawer
    {
        ...
        private bool _isDrawSet = false;

        public Vector2Drawer() : this(0, null) { }
        public Vector2Drawer(float drawSet) : this(drawSet, null) { }
        public Vector2Drawer(float drawSet, params string[] showList)
        {
            _isDrawSet = drawSet == 1? true : false;
            _showList = showList;
        ...
        public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
        {
            ...
            Vector2 value = new Vector2(prop.vectorValue.x, prop.vectorValue.y);//, prop.vectorValue.z);
            value = EditorGUI.Vector2Field(vecRect, label, value);
            ...
            {
                prop.vectorValue = new Vector4(value.x, value.y, prop.vectorValue.z, prop.vectorValue.w);
            }
        }
        ...
        private void HandleDraw(SceneView sceneView)
        {
            ...
            _property.vectorValue = new Vector4(newDir.x, newDir.z, _property.vectorValue.z, _property.vectorValue.w);
